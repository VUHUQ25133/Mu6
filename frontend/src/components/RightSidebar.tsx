		...
		<div className='h-full bg-zinc-900 rounded-lg flex flex-col'>
			<div className='p-4 flex justify-between items-center border-b border-zinc-800'>
				<div className='flex items-center gap-2'>
					...
					<h2 className='font-semibold'>What people are listening to...</h2>
				</div>
			</div>
...
const LoginPrompt = () => (
	<div className='h-full flex flex-col items-center justify-center p-6 text-center space-y-4'>
		<div className='relative'>
			<div
				className='absolute -inset-1 bg-gradient-to-r from-orange-500 to-sky-500 rounded-full blur-lg
       opacity-75 animate-pulse'
		...
		<div className='space-y-2 max-w-[250px]'>
			...
			<p className='text-sm text-zinc-400'>Sign in to discover the music your friends are currently enjoying.</p>
		</div>
	</div>
);
